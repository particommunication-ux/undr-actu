...
const articlesParDefaut = [
    { id: 1, titre: "Session parlementaire ouverte", date: "20 juillet 2026", contenu: "<p>Le Groupe Parlementaire UNDR a participé à l'ouverture de la nouvelle session ordinaire de l'Assemblée Nationale du Tchad.</p><p>Les membres du groupe ont pris part aux travaux d'installation des différentes commissions parlementaires. Le président du groupe, entouré de ses collègues, a prononcé un discours soulignant l'importance de la cohésion nationale et du travail législatif dans cette période charnière pour le pays.</p><p>Les priorités identifiées pour cette session sont : l'examen du budget de l'État, le vote des lois sociales en attente, et le suivi des réformes institutionnelles engagées par le gouvernement de transition.</p>", categorie: "Actualités", image: "", video: "", premium: true },
    { id: 2, titre: "Visite de terrain dans la région Nord", date: "15 juillet 2026", contenu: "<p>Une délégation du Groupe Parlementaire UNDR s'est rendue sur le terrain dans la région du Borkou pour rencontrer directement les populations locales.</p><p>Cette visite de trois jours a permis aux parlementaires de recueillir les préoccupations des habitants concernant l'accès à l'eau potable, l'éducation et la sécurité alimentaire. Des rencontres avec les autorités locales, les chefs de canton et les représentants de la société civile ont été organisées.</p><p>Au terme de la mission, la délégation a remis un rapport de recommandations à la direction du groupe pour transmission aux ministères concernés.</p>", categorie: "Activités", image: "", video: "", premium: false },
    { id: 3, titre: "Déclaration officielle du groupe", date: "10 juillet 2026", contenu: "<p>Le Groupe Parlementaire UNDR a publié une déclaration officielle concernant les récents débats budgétaires à l'Assemblée Nationale.</p><p>Dans ce document, le groupe exprime ses préoccupations quant à la répartition des ressources allouées aux secteurs de la santé et de l'éducation, jugée insuffisante au regard des besoins des populations tchadiennes.</p><p>Le groupe appelle le gouvernement à revoir les priorités budgétaires et à renforcer les investissements dans le développement humain, condition sine qua non d'une stabilité durable et d'une croissance inclusive au Tchad.</p>", categorie: "Communiqués", image: "", video: "", premium: true }
];
